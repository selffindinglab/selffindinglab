        ...
        <main className="pt-24 text-gray-900" style={{ backgroundColor: brandColors.secondary }}>
            ...
            <section className="py-28 px-6 text-center animate-fade-in duration-700">
                <div className="max-w-4xl mx-auto space-y-6">
                    <Smallhead title="숏터뷰 : 1000명의 &lsquo;나&rsquo;를 들여다보다" color="black" />
            ...
            <section className="py-24 px-6 bg-white">
                <div className="max-w-4xl mx-auto space-y-16 text-gray-800">
                    <div className="space-y-5">
                        <Smallhead title="우리는 왜 숏터뷰를 하나요?" color="black" />
                    ...
                    <div className="space-y-5">
                        <Smallhead title="1000명의 &lsquo;나&rsquo;를 모은다는 것" color="black" />
                        <p className="text-lg leading-loose">
                    ...
                    <div className="space-y-5">
                        <Smallhead title="짧지만 깊게 묻는 질문" color="black" />
            ...
            <section className="py-24 px-6 bg-gray-50 text-center">
                <div className="max-w-3xl mx-auto space-y-10">
                    <Smallhead title="기록을 넘어, 연결로" color="black" />
